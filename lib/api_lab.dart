...
class ApiLab {
  ...
  static Future<void> testEverything() async {
    ...
    await _testFinalPattern('Tour (관광공사)',
    ...
    await _testFinalPattern('Tour (관광공사-형태B)',
      '${ApiKeys.tourBase}/KorService1/areaCode1?serviceKey=${ApiKeys.tour}&_type=json',
      [
  ...
  static Future<void> _testFinalPattern(String name, String url, dynamic body) async {
    ...
    try {
      ...
      debugPrint('   응답본문: ${dataStr.substring(0, dataStr.length > 200 ? 200 : dataStr.length)}');

      if (dataStr.contains('resultCode') && (dataStr.contains('00') || dataStr.contains('0000'))) {
